...
# Price 열의 기본정보 확인
print(df["Price"].describe()) # 가격이 20000달러~30000달러에 가장 많이 형성되어 있는 것을 알 수 있음
...
corr = df[num_cols].corr(method = 'pearson') # 상관관계 분석위해 pearson이라는 메소드 씀
print(corr)

# 상관관계를 수치로 보면 힘들기 때문에 밑에 heatmap 처럼 확인
